...
<head>
  ...
  nc_sistema =
  {
    publicar_publicacion:function(pub,nuevo = 0){
      ...
      if (nuevo == 0) {
        $HTML = '<div class="row bord_green white">';
      }
      else{
        $HTML = '<div class="row bord_green white new_pub" style="display:none">';
      }
      $HTML += '<div class="col xl12">';
      $HTML += '<div class="row">';
      $HTML += '<div class="col xl12">';
      $HTML += '<img src="<?php echo base_url(); ?>application/helpers/icons/inicio/second/perfil.png" alt="">';
      $HTML += '<span><?php echo $usuario['nombre']; ?></span>';
      $HTML += '</div>';
      $HTML += '</div>';
      $HTML += '<div class="row">';
      $HTML += '<div class="col xl12">';
      $HTML += '<img class="materialboxed" data-caption="#galletas #galletas #galletas" src="<?php echo base_url(); ?>application/helpers/images/inicio/publicacion.png" alt="" style="width: 100%;">';
      $HTML += '</div>';
      $HTML += '</div>';
      $HTML += '<div class="row center_row">';
      $HTML += '<div class="col xl3">';
      $HTML += '<span>'+pub.liked+'</span>';
      $HTML += '<img src="<?php echo base_url(); ?>application/helpers/images/inicio/like.png" alt="">';
      $HTML += '</div>';
      $HTML += '<div class="col xl3">';
      $HTML += '<span>'+pub.coment+'</span>';
      $HTML += '<img src="<?php echo base_url(); ?>application/helpers/images/inicio/coment.png" alt="">';
      $HTML += '</div>';
      $HTML += '<div class="col xl3">';
      $HTML += '<span>'+pub.share+'</span>';
      $HTML += '<img src="<?php echo base_url(); ?>application/helpers/images/inicio/share.png" alt="">';
      $HTML += '</div>';
      $HTML += '</div>';
      $HTML += '<div class="row">';
      $HTML += '<div class="col xl12">';
      $HTML += '<span style="font-weight:bold"><?php echo $usuario['nombre'] ?></span>';
      $HTML += '<span> '+pub.descripcion+'</span><br>';
      $HTML += '</div>';
      $HTML += '</div>';
      $HTML += '<div class="row">';
      $HTML += '<div class="col xl12">';
      $HTML += '<span>'+pub.fecha_crea+'</span>';
      $HTML += '</div>';
      $HTML += '</div>';
      $HTML += '</div>';
      $HTML += '</div>';
    ...
    cargar_publicaciones:function(){
      ...
      $.ajax({
        url: '<?php base_url()?>Home/cargar_publicaciones',
        type: 'POST',
        dataType: 'json',
        data: {
...
<body class="animated fadeIn">
  <input id="first_time" type="text" name="" value="<?php echo $first_time ?>" hidden="">
  <input id="welcome_text" type="text" name="" value="Bienvenido <?php echo "Pequeño" ?>" hidden="">
  <!-- Fixed navbar -->
    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          <li class="actives"><a href="<?php echo base_url() ?>Home/Perfil/<?php echo $usuario['id_usuario'] ?>">Perfil</a></li>
