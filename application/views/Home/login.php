  ...
  <body>
    ...
    <nav class="navbar navbar-fixed-top navbar-transparent" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url(); ?>Home">Day-Day</a>
        </div>
      </div>
    </nav>
    <div class="wrapper">
        ...
        <form action="" method="POST" autocomplete="off">
          ...
          <a type="submit" href="<?php echo base_url(); ?>Home" name="login" class="btn btn-danger">Login</a>
          ...
          <div class="small-info">
            ...
            <div class="col-sm-10 col-sm-push-1 col-md-6 col-md-push-3 col-lg-6 col-lg-push-3">
              <div class="card-group animated flipInX">
                <div class="card">
                  <div class="card-block">
                    ...
                    <form action="index.html" method="get">
                      ...
                      <div class="center">
                        <a href="<?php echo base_url(); ?>Home" class="btn  btn-azure">
                          Login
                        </a>
                      </div>
                    </form>
                ...
                <div class="card col-md-22 hidden">
                  <div class="card-block">
                    <div class="center">
                      <h4 class="m-b-0"><span class="icon-text">Login</span></h4>
                      <p class="text-muted">Access your account</p>
